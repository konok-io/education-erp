...
Route::prefix('v1')->group(function () {
    ...
    require __DIR__ . '/api/v1/admission.php';
    ...
    require __DIR__ . '/api/v1/exam.php';
    require __DIR__ . '/api/v1/result.php';
    require __DIR__ . '/api/v1/finance.php';
    require __DIR__ . '/api/v1/payment.php';
    require __DIR__ . '/api/v1/hostel.php';
    require __DIR__ . '/api/v1/transport.php';
    require __DIR__ . '/api/v1/library.php';
    require __DIR__ . '/api/v1/inventory.php';
    require __DIR__ . '/api/v1/routine.php';
    require __DIR__ . '/api/v1/hr.php';
    require __DIR__ . '/api/v1/crm.php';
    require __DIR__ . '/api/v1/certificate.php';
    require __DIR__ . '/api/v1/document.php';
    require __DIR__ . '/api/v1/facility.php';
    require __DIR__ . '/api/v1/report.php';
    require __DIR__ . '/api/v1/settings.php';
    require __DIR__ . '/api/v1/cms.php';
    require __DIR__ . '/api/v1/convocation.php';
});

// API v3 routes (DevSecOps Platform, Observability, Backup/DR & Identity)
Route::prefix('v3')->group(function () {
    require __DIR__ . '/api/v3/devsecops.php';
    require __DIR__ . '/api/v3/observability.php';
    require __DIR__ . '/api/v3/backup.php';
    require __DIR__ . '/api/v3/identity.php';
});
